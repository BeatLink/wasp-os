...
class LevelApp():
    NAME = "Level"
    # 1-bit RLE, 48x48, generated from apps/level/icon.png, 91 bytes
    ICON = (
        48, 48,
        b'\xff\x00\xff\x00\xa4\x06\x03\x05\x02\x05\x02\x05\x02\x05\x03\x06'
        b'\x03\x07\x03\x05\x02\x05\x02\x05\x02\x05\x03\x07\x01\x08\x03\x05'
        b'\x02\x05\x02\x05\x02\x05\x03\x10\x03\x05\x02\x05\x02\x05\x02\x05'
        b'\x03\x10\x03\x05\x02\x05\x02\x05\x02\x05\x03\x10\x03\x05\x02\x05'
        b'\x02\x05\x02\x05\x03\x11\x02\x05\x02\x05\x02\x05\x02\x05\x02\xff'
        b'\x00\xea\x01.\x03,\xff\x00\xff\x00\xd4'
    )
