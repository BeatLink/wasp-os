...
"""Build an installable wasp-os app package.
...
def find_mpy_cross(override):
    ...
    # The build directory comes first: older MicroPython left the binary beside
    # its sources, and a leftover there compiles for the wrong bytecode version.
...
def main():
    parser = argparse.ArgumentParser(description='Build a wasp-os app package.')
